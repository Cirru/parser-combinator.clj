...
(deftest parse-token-test
  (testing "testing parse-token at \"aa\""
    (let
      ...
      (are [value keyname] (= value (keyname result))
        false :failed
        "aa" :value
        "" :code))))
...
(deftest parse-program-test
  (testing "testing parse-program at \"a\nb\n  c\nd\""
    (let
      ...
      (are [value keyname] (= value (keyname result))
        false :failed
        (list (list "a") (list "b" (list "c")) (list "d")) :value
        "" :code))))
...
(deftest pare-indent
  (testing "pare indent"
    (is (= (parse-json "indent") (parse-file "indent")))))
...
(deftest parse-indent-test
  (testing "testing parse-indent-test at nested indent"
    (let
      ...
      (are [value keyname] (= value (keyname result))
        false :failed
        (list (list "a" (list (list "b") (list "c")) (list "d") (list "e"))) :value
        "" :code))))
...
(deftest pare-unfolding
  (testing "pare unfolding"
    (is (= (parse-json "unfolding") (parse-file "unfolding")))))
